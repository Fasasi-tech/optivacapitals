                    ...
                    {Menus.map((menu) => {
                        return (
                            <div key={menu.id || index} className='mt-4' title={menu.title}>
                                <Link href={menu.path} className={`flex items-center justify-start gap-4 py-4 px-2 font-bold ${isActive(menu.path)? 'bg-[#722f37] py-4 px-8 rounded-lg text-white': ''}  cursor-pointer rounded-lg `}>
